...
# 存在的问题
# 1.token只有十分钟，refresh后也只有60min，需要设置一个定期获取token的函数，嵌套到数据下载的代码部分  >>每景影像重新获取token
...
roi_geojson='G:/data/OData/block9.geojson'

# 5 数据保存路径
output_dir='G:/data/OData/'
